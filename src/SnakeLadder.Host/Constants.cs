...
namespace SnakeLadder.Host
{
    public class Constants : IConstants
    {
        public List<Ladder> SetLadders()
        {
            ...
            ladders.Add(new Ladder("L-98", 80, new Index(0, 2), new Index(2, 0)));//(L - 98, 20, 02)
            ladders.Add(new Ladder("L-77", 38, new Index(2, 3), new Index(6, 2)));//(L - 77, 62, 23)
            ladders.Add(new Ladder("L-55", 18, new Index(4, 5), new Index(8, 2)));//(L - 55, 82, 45)
            ladders.Add(new Ladder("L-65", 26, new Index(3, 4), new Index(7, 5)));//(L - 65, 75, 34)
            ladders.Add(new Ladder("L-86", 67, new Index(1, 5), new Index(3, 6)));//(L - 86, 36, 15)
            ladders.Add(new Ladder("L-40", 7, new Index(6, 0), new Index(9, 6)));//(L - 40, 96, 60)
            ladders.Add(new Ladder("L-32", 28, new Index(6, 8), new Index(7, 7)));//(L - 32, 77, 68)
            return ladders;
        }
